...
<head>
  ...
  <style>
    ...
    /* Éditeurs de listes du formulaire produit (caractéristiques, galerie) */
    .sous-titre-formulaire { font-size: .78rem; text-transform: uppercase; letter-spacing: .12em; color: var(--ardoise-500); margin: 1.4rem 0 .6rem; border-top: 1px dashed var(--ardoise-200); padding-top: 1.1rem; }
    .ligne-editeur { display: grid; grid-template-columns: 1fr 1fr auto; gap: .6rem; align-items: end; margin-bottom: .55rem; }
    .ligne-editeur--image { grid-template-columns: 64px 1fr auto; }
    .ligne-editeur__miniature { width: 64px; height: 48px; object-fit: cover; border-radius: 8px; background: var(--ardoise-100); border: 1px solid var(--ardoise-200); }
    .ligne-editeur__retirer { color: var(--danger); align-self: end; }
    @media (max-width: 720px) { .ligne-editeur { grid-template-columns: 1fr auto; } .ligne-editeur .champ:nth-child(2) { grid-column: 1 / -1; } .ligne-editeur--image { grid-template-columns: 64px 1fr auto; } }
    .lien-fiche { font-size: .76rem; color: var(--primaire); text-decoration: underline; text-underline-offset: 2px; }
    .lien-fiche:hover { color: var(--accent); }
      ...
      <main class="admin-zone">
        ...
        <section class="vue" id="vue-produits">
          ...
          <div class="panneau" id="panneau-produit" hidden>
            ...
            <p class="note" id="p-lien-public" hidden></p>
            <div class="formulaire" style="border:0;padding:0;box-shadow:none">
              ...
              <div class="champ"><label for="p-description">Description courte</label><textarea id="p-description" rows="2" placeholder="Affichée sur les cartes de la boutique et en tête de la fiche (environ 120 caractères)."></textarea></div>
              <div class="grille-2">
              ...
              <div class="grille-2">
                ...
                <div class="champ"><label for="p-slug">Adresse de la fiche (slug)</label><input id="p-slug" type="text" placeholder="auto : déduit du nom"></div>
              </div>
              <div class="grille-2">
                <div class="champ"><label for="p-image">Image principale (URL)</label><input id="p-image" type="text" placeholder="https://… ou /uploads/…"></div>
                <div class="champ">
              ...
              <h4 class="sous-titre-formulaire">Fiche produit</h4>
              <div class="champ"><label for="p-description-longue">Description longue</label><textarea id="p-description-longue" rows="5" placeholder="Un paragraphe par ligne : affiché sur la fiche du produit."></textarea></div>

              <h4 class="sous-titre-formulaire">Caractéristiques techniques</h4>
              <div id="p-specs"></div>
              <button type="button" class="btn btn--petit btn--fantome" id="p-spec-ajouter" style="justify-self:start;margin-bottom:1rem">+ Ajouter une caractéristique</button>

              <h4 class="sous-titre-formulaire">Galerie d'images</h4>
              <div id="p-images"></div>
              <button type="button" class="btn btn--petit btn--fantome" id="p-image-ajouter" style="justify-self:start">+ Ajouter une image</button>
              <div class="champ" style="margin-top:.75rem">
                <label for="p-fichiers-galerie">… ou téléverser des images</label>
                <input id="p-fichiers-galerie" type="file" accept="image/png,image/jpeg,image/webp,image/svg+xml" multiple>
              </div>
